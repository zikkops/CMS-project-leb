          ...
          <div style={{
            ...
            <Link href="/menu"
              ...
              style={{
                ...
                gap: '0.8rem',
                border: `1px solid ${menuHovered ? 'rgba(var(--teal-rgb),0.6)' : 'rgba(var(--teal-rgb),0.25)'}`,
                background: menuHovered ? 'rgba(var(--teal-rgb),0.12)' : 'rgba(var(--teal-rgb),0.05)',
                transform: menuHovered ? 'translateY(-4px)' : 'none',
                boxShadow: menuHovered ? '0 12px 24px rgba(var(--teal-rgb),0.2)' : 'none',
                transition: 'all 0.3s ease',
              }}>
              <div style={{
                ...
                borderRadius: '50%',
                border: `1px solid ${menuHovered ? 'var(--teal)' : 'rgba(var(--teal-rgb),0.4)'}`,
