...
import { useBranchTableLayout, adjacentSelectableIds, type TableMarker } from '@big-cms/shared/branchTableLayouts'
    ...
    <>
      ...
      <main>
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: isMobile ? '8rem 1.25rem 3rem' : '9rem 3rem 5rem' }}>
          ...
          <p style={{ fontFamily: 'var(--font-inter)', fontSize: '0.82rem', color: 'rgba(var(--offwhite-rgb),0.4)', marginBottom: '1.5rem', lineHeight: 1.6 }}>
            Party too big for one table?{' '}
            <span style={{ color: 'rgba(var(--offwhite-rgb),0.6)' }}>Select a table, then tap any highlighted neighbour to link them together.</span>
          </p>
          ...
          {loading ? (
            ...
            <>
              {selectedIds.length === 0 ? (
                <p style={{ fontFamily: 'var(--font-inter)', fontSize: '0.8rem', color: 'rgba(var(--offwhite-rgb),0.45)', marginBottom: '1rem' }}>
                ...
                <>
                  ...
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor: '#0d1f1e', borderBottom: '1px solid rgba(var(--teal-rgb),0.4)',
                  ...
                  >
                    <div style={{
                      ...
                      <div>
                        ...
                        <p style={{ fontFamily: 'var(--font-inter)', fontSize: '0.75rem', color: 'rgba(var(--offwhite-rgb),0.5)', marginTop: '0.3rem' }}>
                          {adjacentIds.size > 0
