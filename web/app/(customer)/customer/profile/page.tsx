...
import { useCustomerUser, signOutCustomer, resendVerificationEmail, refreshEmailVerified } from '@big-cms/shared/customerAuth'
import { useIsMobile } from '@big-cms/shared/useIsMobile'
import { useUserRedemptions, cancelRedemption, type Redemption } from '@big-cms/shared/redemptions'
import { cancelTransaction } from '@big-cms/shared/loyalty'
import { useUserEventReservations } from '@big-cms/shared/eventReservations'
import { useUserTableReservations } from '@big-cms/shared/tableReservations'
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.5rem', flexWrap: 'wrap' }}>
          ...
          {showStatus && (
            <span style={{
              ...
              borderRadius: '2px',
              backgroundColor: `color-mix(in srgb, ${STATUS_COLORS[tx.status]} 15%, transparent)`,
  ...
  return (
    <Link
      ...
      style={{
        ...
        display: 'block',
        textAlign: 'center',
        backgroundColor: hovered ? `color-mix(in srgb, ${color} 8%, transparent)` : (variant === 'solid' ? color : 'transparent'),
        ...
        boxShadow: hovered ? `0 0 20px color-mix(in srgb, ${color} 31%, transparent), inset 0 0 20px color-mix(in srgb, ${color} 8%, transparent)` : 'none',
              ...
              {perks.map(p => {
                ...
                return (
                  <div key={p.id} style={{
                    ...
                    backgroundColor: unlocked ? `color-mix(in srgb, ${color} 5%, transparent)` : 'rgba(var(--overlay-rgb),0.02)',
                    border: `1px solid ${unlocked ? `color-mix(in srgb, ${color} 25%, transparent)` : 'rgba(var(--overlay-rgb),0.06)'}`,
                    ...
                    <span style={{
                      ...
                      padding: '0.2rem 0.6rem',
                      borderRadius: '2px',
                      backgroundColor: unlocked ? `color-mix(in srgb, ${color} 15%, transparent)` : 'rgba(var(--overlay-rgb),0.06)',
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.5rem', flexWrap: 'wrap' }}>
                          ...
                          <span style={{
                            ...
                            padding: '0.2rem 0.6rem',
                            borderRadius: '2px',
                            backgroundColor: `color-mix(in srgb, ${REDEMPTION_STATUS_COLORS[r.status]} 15%, transparent)`,
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.5rem', flexWrap: 'wrap' }}>
                          ...
                          <span style={{
                            ...
                            padding: '0.2rem 0.6rem',
                            borderRadius: '2px',
                            backgroundColor: `color-mix(in srgb, ${RESERVATION_STATUS_COLORS[r.status]} 15%, transparent)`,
