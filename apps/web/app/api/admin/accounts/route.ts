...
import { syncClaims } from '@big-cms/shared/server/claims'
import { logActivity, logUpdate } from '@big-cms/shared/server/activityLog'
import { isRole, SECTION_ACCESS, type Role } from '@big-cms/shared/roles'
import { BRANCHES } from '@big-cms/shared/branches'
import { isDepartment } from '@big-cms/shared/departments'
