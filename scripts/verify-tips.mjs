...
console.log('\nthe labour report: hours, cost at the day\'s rate, tips and what is owed (UPGRADE.md T7.11)')
{
  ...
  eq('a day with sales and no priced labour is 0%, a day with no sales is none', [r.days.find(d => d.day === '2026-09-15').labourPercent, r.days.find(d => d.day === '2026-09-16').labourPercent], [0.12, null])
