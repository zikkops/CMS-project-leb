...
import { listEndOfDayLogs, type EndOfDayLog } from '@big-cms/shared/endOfDay'
            ...
            {logs.map(entry => (
              <div key={entry.id} style={{
                ...
                <span style={{
                  ...
                  border: `1px solid ${entry.action === 'submit' ? 'rgba(var(--teal-rgb),0.3)' : 'rgba(var(--brand-secondary-rgb),0.3)'}`,
                ...
                <div>
                  <p style={{ fontSize: '0.88rem', color: 'var(--offwhite)', marginBottom: '0.2rem' }}>
                    ...
                    {' · '}
                    <span style={{ color: 'rgba(var(--offwhite-rgb),0.6)' }}>{entry.date}</span>
                  </p>
