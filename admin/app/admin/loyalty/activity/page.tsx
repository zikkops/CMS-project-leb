...
import type { FieldChange } from '@big-cms/shared/activityLog'
            ...
            {filtered.map(log => (
              <div key={log.id} style={{
                ...
                <span style={{
                  ...
                  letterSpacing: '0.1em',
                  textTransform: 'uppercase',
                  color: SECTION_COLORS[log.section] ?? 'rgba(var(--offwhite-rgb),0.4)',
                  fontFamily: 'var(--font-inter)',
                }}>{log.section}</span>
              ...
              <tbody>
                {filtered.map(log => (
                  <tr key={log.id} style={{ borderBottom: '1px solid rgba(var(--overlay-rgb),0.04)' }}>
                    ...
                    <td style={{ padding: '1rem 1.2rem', fontFamily: 'var(--font-inter)', fontSize: '0.78rem', color: SECTION_COLORS[log.section] ?? 'rgba(var(--offwhite-rgb),0.5)', verticalAlign: 'top', whiteSpace: 'nowrap' }}>
                      {log.section}
                    </td>
